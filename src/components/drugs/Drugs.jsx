...
export default class Drugs extends Component {
  ...
  editDrug0(drugId) {
    console.log('edit method on| new price =' + drugId.price)
              ...
              <div class="modal-body">
                ...
                <form class="form-horizontal" id="updateDrug" onSubmit={this.editDrug.bind(this)}>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" id="supplier" disabled="disabled">
                        {/* <option value={this.state.supplier._id} selected="selected">{this.state.supplier.companyName}</option> */}
                      </select>
                    </div>
                  </div>
